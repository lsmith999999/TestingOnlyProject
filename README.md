...
<a name="FunctionClassification"></a>10. `Function's classification` - Whether the function is a free function (which includes static member functions), a non-static member function, or a functor. Note that "*free*" functions are simply functions that conform to <a href="https://en.cppreference.com/w/cpp/types/is_function">std::is_function</a> but can't contain the "<i>const</i>" or "<i>volatile</i>" <a href="https://en.cppreference.com/w/cpp/language/member_functions#Member_functions_with_cv-qualifiers"><i>cv-qualifiers</i></a> nor the "<i>&</i>" or "<i>&&</i>" <a href="https://en.cppreference.com/w/cpp/language/member_functions#Member_functions_with_ref-qualifier"><i>ref-qualifiers</i></a>)
