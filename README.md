...
This section describes how to use the module version of "*FunctionTraits*" and can be bypassed if you don't require it (most don't at this writing). Due to the inherently detailed nature of modules however, a separate [README_MODULES.md](README_MODULES.md) file exists for it. See file for complete details.
