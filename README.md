...
See [here](https://godbolt.org/z/fx8MWGv99) for a complete working example (demo that displays all available traits for various sample functions - for those who want to get right to the code). Additional usage examples also exist further below.
